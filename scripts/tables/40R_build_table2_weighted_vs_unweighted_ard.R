...
dat <- readRDS(file.path(DERIVED_DIR, "24R_operation_dataset_elective_abdominal_major.rds"))

fit_weighted <- readRDS(file.path(DERIVED_DIR, "34R_model_primary_abdominal.rds"))
fit_unweighted <- readRDS(file.path(DERIVED_DIR, "34R_model_primary_abdominal_unweighted.rds"))
...
readr::write_csv(
  table2_long,
  file.path(TABLES_DIR, "40R_table2_weighted_vs_unweighted_ard_raw_long.csv")
)

readr::write_csv(
  table2_long_formatted,
  file.path(TABLES_DIR, "40R_table2_weighted_vs_unweighted_ard_formatted_long.csv")
)

readr::write_csv(
  table2_wide,
  file.path(TABLES_DIR, "40R_table2_weighted_vs_unweighted_ard_formatted_wide.csv")
)

saveRDS(
  table2_long,
  file.path(DERIVED_DIR, "40R_table2_weighted_vs_unweighted_ard_raw_long.rds")
)

message("Saved:")
message(file.path(TABLES_DIR, "40R_table2_weighted_vs_unweighted_ard_formatted_wide.csv"))
message("==== TABLE 2 WEIGHTED VS UNWEIGHTED COMPLETE ====")